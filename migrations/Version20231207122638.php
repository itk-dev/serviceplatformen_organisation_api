...
final class Version20231207122638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bruger_registrering_tilknyttede_personer (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', bruger_registrering_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', reference_id_uuididentifikator VARCHAR(255) DEFAULT NULL, INDEX IDX_2DAA808FCB4DA18F (bruger_registrering_id), INDEX bruger_tilknyttede_personer_ref_uuid_idx (reference_id_uuididentifikator), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE organisation_funktion_registrering_funktionstype (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', reference_id_uuididentifikator VARCHAR(255) DEFAULT NULL, INDEX organisation_funktionstype_ref_uuid_idx (reference_id_uuididentifikator), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE organisation_funktion_registrering_tilknyttede_brugere (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', organisation_funktion_registrering_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', reference_id_uuididentifikator VARCHAR(255) DEFAULT NULL, INDEX IDX_60D0A30B55A4FC6 (organisation_funktion_registrering_id), INDEX organisation_tilknyttede_brugere_ref_uuid_idx (reference_id_uuididentifikator), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE organisation_funktion_registrering_tilknyttede_enheder (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', organisation_funktion_registrering_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', reference_id_uuididentifikator VARCHAR(255) DEFAULT NULL, INDEX IDX_6488AFBB55A4FC6 (organisation_funktion_registrering_id), INDEX organisation_funktion_tilknyttede_enheder_ref_uuid_idx (reference_id_uuididentifikator), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
