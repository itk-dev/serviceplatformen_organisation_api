 ...
 */
final class Version20231027131249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE person_registrering (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', person_id VARCHAR(255) NOT NULL, note_tekst VARCHAR(255) DEFAULT NULL, tidspunkt VARCHAR(255) NOT NULL, livscyklus_kode VARCHAR(255) NOT NULL, INDEX IDX_318A3713217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE person_registrering_egenskab (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', person_registrering_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', brugervendt_noegle_tekst VARCHAR(255) NOT NULL, cpr_nummer_tekst VARCHAR(255) DEFAULT NULL, navn_tekst VARCHAR(255) NOT NULL, INDEX IDX_F894253DE54B1222 (person_registrering_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
